...
Write-Output "Covers: ${TC_COVERED}" | Tee-Object -FilePath $summaryLog
...
#
Write-Output "Good pings = $goodPings" | Tee-Object -FilePath $summaryLog
Write-Output "Bad pings  = $badPings"  | Tee-Object -FilePath $summaryLog
