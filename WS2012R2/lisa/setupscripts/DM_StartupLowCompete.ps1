...
.Synopsis
 ...
 Description:
   ...
   .Parameter vmName
    ...
    .Example
    setupscripts\DM_StartupLowCompete.ps1 -vmName nameOfVM -hvServer localhost -testParams 'sshKey=KEY;ipv4=IPAddress;rootDir=path\to\dir;vmName=NameOfVM1;vmName=NameOfVM2'
#>
...
"Deltas VM2 after it stabilized"
"  VM2 Assigned : ${vm2AssignedDelta}"
...
"Deltas VM1 after it stabilized"
"  VM1 Assigned : ${vm1AssignedDelta}"
"  VM1 Demand   : ${vm1DemandDelta}"
