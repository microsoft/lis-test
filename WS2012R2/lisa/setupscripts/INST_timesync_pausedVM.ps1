#####################################################################
#
# This test will check the time sync of guest OS with the host. It will pause the VM.
# It will wait for 10 mins, resume the VM from paused state and will re-check the time sync.
#
# testParams
#    HOME_DIR=C:\lisa\
#    ipv4=
